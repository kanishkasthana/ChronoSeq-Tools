...
parser=argparse.ArgumentParser(description="Script to Combine two Time-Tagged DGEs into a Single DGE. Useful when you have multiple splits from the same experiment with different Illumina Indices.")
...
write("Started Combining into a Single DGE.")
