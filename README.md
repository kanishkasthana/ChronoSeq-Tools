...
+ Once everything above has been sorted, you can generate the Digital Gene Expression Matrices for your sequencing data by running the following Scripts in order:
    1. [ChronoSeqPipelineNoCorrectionTimeTagChronoV5.py](ChronoSeqPipelineNoCorrectionTimeTagChronoV5.py) or [ChronoSeqPipelineNoCorrectionTimeTagChronoV5HumanOnly_hg38.py](ChronoSeqPipelineNoCorrectionTimeTagChronoV5HumanOnly_hg38.py)
