...
HumanFileName,inputFileName=getNewFileName(input_filename,".HUMAN_ONLY.bam")
bash(dropseq_path+"/FilterBam INPUT="+inputFileName+" OUTPUT="+HumanFileName+" REF_SOFT_MATCHED_RETAINED=HUMAN"+" TMP_DIR="+temporary_directory_path)

MouseFileName,inputFileName=getNewFileName(input_filename,".MOUSE_ONLY.bam")
bash(dropseq_path+"/FilterBam INPUT="+inputFileName+" OUTPUT="+MouseFileName+" REF_SOFT_MATCHED_RETAINED=MOUSE"+" TMP_DIR="+temporary_directory_path)

OutputFileName,previousFileName=getNewFileName(HumanFileName,".dge.txt.gz")
summaryFileName=OutputFileName+".summary.txt"
bash(dropseq_path+"/DigitalExpression I="+HumanFileName+" O="+OutputFileName+" SUMMARY="+summaryFileName+" CELL_BC_FILE="+barcodes_file+" TMP_DIR="+temporary_directory_path)

OutputFileName,previousFileName=getNewFileName(MouseFileName,".dge.txt.gz")
summaryFileName=OutputFileName+".summary.txt"
bash(dropseq_path+"/DigitalExpression I="+MouseFileName+" O="+OutputFileName+" SUMMARY="+summaryFileName+" CELL_BC_FILE="+barcodes_file+" TMP_DIR="+temporary_directory_path)
