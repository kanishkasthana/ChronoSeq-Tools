...
parser=argparse.ArgumentParser(description="Script for Drop-Seq Pipeline.")
...
bash('bash '+chronoseq_path+'Drop-seq_alignment.sh -g '+starGenomeIndex+' -r '+ref_seq+' -d '+dropseq_path+' -t '+temporary_directory_path+' '+OutputFileName)
