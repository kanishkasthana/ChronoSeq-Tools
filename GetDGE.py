...
parser=argparse.ArgumentParser(description="Script for Getting Counts Data for Making the Mixed-Species Plot. Make sure you run getTopBarcodes before running this.")
...
barcodes_file,previousFileName=getNewFileName(input_filename,".counts.txt.gz.top_barcodes.txt")
time_tags_file,previousFileName=getNewFileName(input_filename,".time_tags.csv")
